...
{
    public class UpdateStudentInformationRequestValidator : AbstractValidator<UpdateStudentInformationRequest>
    {
        public UpdateStudentInformationRequestValidator()
        {
